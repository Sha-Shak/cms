...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/areas.php?res=0&msg='Insert Data'&mod=5");
    }
...
left join transmode tr on cl.transmode=tr.id order by cl.id"; 
    ...
    <br>
                	<form method="post" action="areaList.php" id="form1">
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                        ...
                        <div class="col-sm-1">
                          <input type="submit" name="add" value="+ Create New Area " id="add"  class="btn btn-md btn-info   pull-right responsive-alignment-r2l">
                        </div>
                      </div>
                    </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').DataTable({
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=area'
                },
                'columns': [
                     { data: 'id' },
                    { data: 'dn' },
