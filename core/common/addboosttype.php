...
if ( isset( $_POST['cancel'] ) ) {
      ...
      header("Location: ".$hostpath."/boosttypeList.php?res=01&msg='New Entry'&id=''&mod=5");
}
else
{
    ...
    if ( isset( $_POST['add'] ) ) {
      ...
      $tmpFilePath = $_FILES['attachment1']['tmp_name'];
        ...
        imagejpeg($resized, "../../core/images/icons/boosttype/".$photo);
    ...
    $qry= "insert into boosttype( `title`, `description`, `icon`, `makeby`, `makedt`) 
    ...
    if ( isset( $_POST['update'] ) ) {
      ...
      if($tmpFilePath!='')
        ...
        $qry="update boosttype set `title`='".$title."',`description`='".$description."', `icon`='".$photo."' where `id`=".$aid."";
       // echo $qry;die;
        
        
    }
   
   $ur="/boosttypeList.php?&mod=5";
    ...
    if ($conn->query($qry) == TRUE) {
                ...
                header("Location: ".$hostpath."/boosttypeList.php?pg=1&mod=5pg=1&mod=5");
    } else {
         $err="Error: " . $qry . "<br>" . $conn->error;
          header("Location: ".$hostpath."/boosttypeList.php?pg=1&mod=5");
          //echo $err;
    }
