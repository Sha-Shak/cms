...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/state.php?res=0&msg='Insert Data'&mod=5");
    }
          ...
          <div class="row">
            ...
            <p>&nbsp;</p>
              ...
              <div class="panel panel-info">
      			<div class="panel-heading"><h1>All State</h1></div>
    				<div class="panel-body">
    
    <span class="alertmsg">
    </span>
    <br>
                	<form method="post" action="stateList.php" id="form1">
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').DataTable({
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/data_all_list.php?action=state'
                },
                'columns': [
                     { data: 'id' },
                    { data: 'title' },
