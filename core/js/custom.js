...
//$('.unitprice_otc').append('<input type="text" name="unitTotalAmount_otc" class="unitTotalAmount_otc">');
//$('.unitprice_mrc').append('<input type="text" name="unitTotalAmount_mrc" class="unitTotalAmount_mrc">');
...
function sumPriceV2(){
	...
	$(".toClone").each(function(){
		$(this).find(".unitprice_otc").change(function() {
				...
				$(this).parent().parent().parent().parent().parent().find(".quantity_mrc").val("");
				$(this).parent().parent().parent().parent().parent().find(".unitprice_mrc").val("");

			
			 qtn_otc	= $(this).parent().parent().parent().find(".quantity_otc").val();

			 up_otc	= $(this).val();
			 
			 if(up_otc)
			 utp_otc	= qtn_otc*up_otc;
			 else
			 utp_otc	= 0;
			...
			$(this).parent().find('.unitTotalAmount_otc').val(utp_otc);
			//alert($(this).parent().find('.unitTotalAmount_otc').val());
		...
		$(this).find(".unitprice_mrc").change(function() {
			 ...
			 qtn_mrc	= $(this).parent().parent().parent().find(".quantity_mrc").val();

			 up_mrc	= $(this).val();
			 utp_mrc	= qtn_mrc*up_mrc;
			 utp_mrc = utp_mrc.toFixed(2);
			
			
			//save mrc total
			$(this).parent().find('.unitTotalAmount_mrc').val(utp_mrc);
			
						
			 //check curent unitTotalAmount
			// uta = $(this).parent().parent().parent().parent().parent().find(".unitTotalAmount").val();
			 
			 uta = $(this).parent().parent().parent().parent().parent().find(".unitTotalAmount_otc").val();
