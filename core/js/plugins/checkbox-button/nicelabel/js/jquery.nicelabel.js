...
;(function( $ ){
	...
	$.fn.nicelabel = function(options) {
		...
		var settings = $.extend({},{
			...
			//checked_text: $(this).attr('value'),
			//unchecked_text: $(this).attr('value'),
			
			
			checked_ico: 'js/plugins/checkbox-button/nicelabel/ico/tick-checked.png', 	//如果是文本按钮,默认选定图标
			
			unchecked_ico: 'js/plugins/checkbox-button/nicelabel/ico/tick-unchecked.png', 	//如果是文本按钮,默认未选定图标
		...
		return this.each(function(){
			...
			var obj = $(this),
				...
				//label_opts = toJSON($(this).attr('value') || '{}'), 	//将字符串转化为对象
