...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/nareas.php?res=0&msg='Insert Data'&mod=5");
    }
...
left join transmode tr on cl.transmode=tr.id order by cl.id"; 
    ...
    <br>
                	<form method="post" action="nareasList.php" id="form1">
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').DataTable({
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/data_all_list.php?action=areas'
                },
                'columns': [
                     { data: 'id' },
                    { data: 'title' },
