...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/vmoney.php?res=0&msg='Insert Data'&mod=5");
    }
          ...
          <div class="row">
            ...
            <p>&nbsp;</p>
              ...
              <div class="panel panel-info">
      			<div class="panel-heading"><h1>All Virtual Money</h1></div>
    				<div class="panel-body">
    
    <span class="alertmsg">
    </span>
    <br>
                	<form method="post" action="vmoneyList.php" id="form1">
                ...
                <div >
                    ...
                    <table id='listTable' class='display dataTable' width="100%">
                        ...
                        <tr>
                            ...
                            <th>Description</th>
                            <th>Virtual Money Type Title</th>
                            <th>Offer Amount</th>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').DataTable({
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/data_all_list.php?action=vmoney'
                },
                'columns': [
                     { data: 'id' },
                    { data: 'title' },
