...
else
{
    ...
    if ($res==4)
    {
        $qry="SELECT `id`, `title`, `descr` FROM `paymode` WHERE id= ".$atid; 
       //echo $qry; die;
    ...
    {
        $aid='';$title='';$description='';$makeby=$usr;
        $mode=1;//Insert mode
        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12">
                    <p>&nbsp;</p> <p>&nbsp;</p>
                    <p>
                        <form method="post" action="common/addpay.php"  id="form1" enctype="multipart/form-data"> <!--onsubmit="javascript:return WebForm_OnSubmit();" -->
                            <div class="panel panel-info">
      			                <div class="panel-heading"><h1>Pay Information</h1></div>
