...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/packagesetup.php?res=0&msg='Insert Data'&mod=5");
    }
          ...
          <div class="row">
            ...
            <p>&nbsp;</p>
              ...
              <div class="panel panel-info">
      			<div class="panel-heading"><h1>All Package Setup</h1></div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').DataTable({
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/data_all_list.php?action=packagesetup'
                },
                'columns': [
                    { data: 'id' },
                    { data: 'packagesetup' },
