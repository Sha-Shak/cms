          ...
          <div class="row">
            ...
            <p>&nbsp;</p>
              ...
              <div class="panel panel-info">
      			<div class="panel-heading"><h1>All Country List</h1></div>
    				<div class="panel-body">
    
    <span class="alertmsg">
    </span>
    <br>
                	<form method="post" action="countryList.php" id="form1">
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').DataTable({
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/data_all_list.php?action=country'
                },
                'columns': [
                     { data: 'id' },
                    { data: 'title' },
