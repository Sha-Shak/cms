...
else
{
    ...
    if ($res==4)
    {
        $qry="SELECT `id`, `title`, `descr` FROM `paytype` WHERE id= ".$atid; 
       //echo $qry; die;
        ...
        else
        {
            ...
            if ($result->num_rows > 0)
            {
                while($row = $result->fetch_assoc()) 
                    { 
                        $aid=$row["id"];$title=$row["title"];$description=$row["descr"];
                    }
            }
        }
    $mode=2;//update mode
    ...
    {
        $aid='';$title='';$description='';$makeby=$usr; $makedt= date("Y-n-j H:i:s");
        $mode=1;//Insert mode
        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12">
                    <p>&nbsp;</p> <p>&nbsp;</p>
                    <p>
                        <form method="post" action="common/addpaytype.php"  id="form1" enctype="multipart/form-data"> <!--onsubmit="javascript:return WebForm_OnSubmit();" -->
                            <div class="panel panel-info">
      			                <div class="panel-heading"><h1>Pay Type Information</h1></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="ref">Pay Type Title.</label>
