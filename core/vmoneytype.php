...
else
{
    ...
    if ($res==4)
    {
        $qry="SELECT `id`, `title`, `description` FROM `virtualmoneyType` WHERE id= ".$atid; 
       // echo $qry; die;
        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12">
                    <p>&nbsp;</p> <p>&nbsp;</p>
                    <p>
                        <form method="post" action="common/addvirtualmoneytype.php"  id="form1" enctype="multipart/form-data"> <!--onsubmit="javascript:return WebForm_OnSubmit();" -->
                            <div class="panel panel-info">
      			                <div class="panel-heading"><h1>Virtual Money Information</h1></div>
