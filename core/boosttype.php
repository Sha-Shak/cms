...
else
{
    ...
    if ($res==4)
    {
        $qry="SELECT `id`,`title`,`icon`, `description` FROM `boosttype`  WHERE id=".$atid; 
       //echo $qry; die;
                ...
                while($row = $result->fetch_assoc()) 
                    { 
                        $aid=$row["id"];$cat=$row["title"];$aimg=$row["icon"]; $description=$row["description"];  
                          $photo="../../core/images/icons/boosttype/".$aimg."?nocache=".time();
                    }
            }
        }
    $mode=2;//update mode
        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12">
                    <p>&nbsp;</p> <p>&nbsp;</p>
                    <p>
                        <form method="post" action="common/addboosttype.php"  id="form1" enctype="multipart/form-data"> <!--onsubmit="javascript:return WebForm_OnSubmit();" -->
                            <div class="panel panel-info">
      			                <div class="panel-heading"><h1>Boost Type Information</h1></div>
				                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="ref">Boost Type Title</label>
                                                <input type="text" class="form-control" id="cat" name="cat" value="<?php echo $cat;?>">
                                            </div>        
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="ref">Boost Type </label>
                                                <input type="text" class="form-control" id="description" name="description" value="<?php echo $description;?>">
                                            </div>        
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <strong>Boost Type Icone</strong>
                            ...
                            <div class="button-bar">
                                <?php if($mode==2) { ?>
    	                        <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="update" value="Update Boost Type"  id="update" > <!-- onclick="javascript:messageAlert('Event is fired from the page and messaged is pased via parameter. will be desolve in 5 sec')" -->
                                <?php } else {?>
                                <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="add" value="Add Boost Type"  id="add" >
                                <?php } ?>  
