...
<body class="list">
    <!-- Fixed navbar-->
<!-- MY BL <nav class="navbar navbar-default navbar-fixed-top">
...
<?php } ?>
                        <button type="button" i d="my-btn" class="add-btn">+Add</button>
...
<?php } ?>
                ...
                <!-- END JOB BLOCK -->
                  <span class="beni-block">
                    ...
                    <ul class="my-table">
                        ...
                        <li class="table-header">
                            <div class="col">Benifits</div>
                            <div class="col ">Effective Date</div>
                            <div class="col">Entitled</div>
                            <div class="col">Remarks</div>

                        </li>

                        <li class="table-row">
                            <div class="col">Promoted</div>
                            <div class="col">02-April-2021</div>
                            <div class="col ">Yes</div>
                            <div class="col ">Accountant</div>

                        </li>
                        <button type="button" id="my-btn4" class="add-btn"
                           >+Add</button>
                    ...
                    <ul class="my-table">
                        ...
                        <li class="table-row">
                            ...
                            <div class="col">02-April-2020</div>
                            <div class="col">80000</div>
                            <div class="col">Monthly Salary</div>
                            <div class="col">Monthly Salary</div>
                 ...
                 <span class="atten-block">
                    ...
                    <ul class="my-table">
                        ...
                        <li class="table-header">
                            ...
                            <div class="col ">Date</div>
                            <div class="col">Office Time</div>
                            <div class="col">Shift Type</div>
                            <div class="col">Status</div>
                            <div class="col">Entry Time</div>
                            <div class="col">Exit Time</div>
                            <div class="col">Total Hrs</div>
                        ...
                        <li class="table-row">
                            ...
                            <div class="col">02-April-2021</div>
                             <div class="col">Fever</div>
                            <div class="col ">1</div>
                             <div class="col">02-April-2021</div>
                              <div class="col">03-April-2021</div>
                            <div class="col ">Mr. Fran</div>
                             <div class="col">02-April-2021</div>
                             <div class="col"></div>
                            <div class="col "></div>

                        </li>
                        <button type="button" i d="my-btn" class="add-btn"
                           >+Add</button>
  ...
  <select name="ben" class="modal2-field" >
  ...
  <select name="ben-ent" class="modal2-field" >
                        ...
                        <option value="">Laptop</option>
                             ...
                             <div class="col-4 mod-col">
                              ...
                              <div class="col-4 mod-col">
                                 ...
                                 <input type="text" class="modal2-field ef-date">
                             </div>
